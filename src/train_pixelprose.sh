...
#SBATCH --job-name=train_pixelprose
#SBATCH --output=./cluster_logs/train_pixelprose.txt
...
srun env -u CUDA_VISIBLE_DEVICES torchrun \
    ...
    --warmup 2000 \
    --epochs 32  \
    --train-data '/datasets/pixelprose/data/{00000..01699}.tar'  \
    --train-num-samples 15037386 \
    --val-data 'coco' \
